...
import { shouldOpenNewSubjectForm } from "@/lib/studyRoutes";
...
export default function Subjects() {
  ...
  useEffect(() => {
    if (shouldOpenNewSubjectForm(search)) setCreating(true);
  }, [search]);
