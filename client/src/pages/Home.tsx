...
export default function Home() {
  ...
  return <div className="mx-auto max-w-7xl">
    <PageHeader eyebrow="Núcleo de aprendizagem" title={<>Olá, <span className="text-fuchsia-400">{name}</span>.</>} description="Seu sistema está pronto para transformar materiais em uma rotina de estudo inteligente." action={<Button onClick={() => navigate("/materiais")} className="neon-button gap-2"><Plus className="size-4" />Adicionar material</Button>} />
